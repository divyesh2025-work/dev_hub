"""
Python ConRevIOC Strategy - Test Version (using Mock SDK)

This is a test/demo version using the mock SDK for easy testing without C++ compilation.
"""

from sdk.python_sdk_mock import (
...
class ConRevIOCStrategy(StrategyAPI):
    ...
    def __init__(self):
        ...
        # Market data cache
        self.fut_market: MarketData = None
        self.call_market: MarketData = None
        self.put_market: MarketData = None
    ...
    def on_add(self, params: dict) -> str:
        ...
        try:
            ...
            print("✓ ConRevIOC strategy added")
    ...
    def on_run(self) -> str:
        ...
        try:
            ...
            print("✓ ConRevIOC strategy running")
    ...
    def on_stop(self) -> str:
        ...
        try:
            ...
            print("✓ ConRevIOC strategy stopped")
    ...
    def on_remove(self) -> str:
        ...
        try:
            if self.active:
                self.on_stop()
            print("✓ ConRevIOC strategy removed")
    ...
    def on_market_event(self, market: MarketData):
        ...
        print(f"✓ Opportunity detected: spread={spread}")
        ...
        print(f"✓ Orders placed: parent_id={ret}, spread={spread}")
    ...
    def on_order_update(self, update: OrderUpdate):
        ...
        if update.state == OrderState.FILL:
            ...
            print(f"✓ Fill: {update.filled_qty} @ {update.avg_fill_price}")
...
if __name__ == "__main__":
    ...
    strategy.on_market_event(market)
    
    # Simulate fill
    print(f"\n4. Simulating order fill...")
    fill = OrderUpdate(
        oms_order_id=1,
        exchange_order_id=12345,
        token=100,
        side=OrderSide.BUY,
        state=OrderState.FILL,
        ordered_price=1001,
        ordered_qty=10,
        filled_qty=10,
        avg_fill_price=1000
    ...
    # Query state
    print(f"\n5. Querying strategy state...")
    state = strategy.on_query()
    print(f"   {state}")
